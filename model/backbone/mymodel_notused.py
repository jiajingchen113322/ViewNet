...
'''
In this model, I do the development on GaitSet.
...
class view_pooling(nn.Module):
    def __init__(self,inchannel=32,out_channel=32):
        super().__init__()
        self.net=nn.Sequential(nn.Conv2d(4*inchannel,out_channel,kernel_size=3,padding=1),
                               nn.ReLU())
...
class Mymodel(nn.Module):
    ...
    def forward(self,inpt):
        ...
        # the feature shape is (num_bin,batch_size,feat_dim)/(62,20,256s)
        return feature
